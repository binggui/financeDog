...
//        [self addSubview:skipButton];
        ...
        for (int i=0; i<imageNameArray.count; i++) {
            ...
            if (i == imageNameArray.count-1 && isHidden == NO) {
                ...
                UIButton *startButton = [[UIButton alloc]initWithFrame:CGRectMake(DDScreenW*0.25, DDScreenH*0.87, DDScreenW*0.5, DDScreenH*0.08)];
                ...
                [startButton setBackgroundImage:[UIImage imageNamed:@"按钮1"] forState:UIControlStateNormal];

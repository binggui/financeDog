//
//  BGMyCollectionTableViewController.m
//  框架分析
//
...
@interface BGMyCollectionTableViewController ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation BGMyCollectionTableViewController
